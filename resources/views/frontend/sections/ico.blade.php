...
@endphp
    ...
    <section class="hero bg_img scroll-section"
      style="background-image: url({{ getImage( 'ico/assets/images/frontend/banner/' .@$banner->data_values->background_image, '1920x1080') }});"
        ...
        <div class="row justify-content-between align-items-center">
          ...
          <div class="col-xxl-5 col-lg-6 mt-lg-0 mt-5">
            <div class="count-wrapper glass--bg rounded-2 text-center">
              ...
              <a href="{{ Auth::user() != null ? route('user.coin.buy') : route('login') }}" class="btn btn--base mt-4">@lang('Buy Token Now')</a>
            </div>
          </div>
        </div>
      </div>
