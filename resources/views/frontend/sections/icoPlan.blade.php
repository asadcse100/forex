...
<!-- ico section start -->
<section class="pt-100 pb-100 bg_img overlay--one" style="background-image: url('{{ getImage( 'ico/assets/images/frontend/icoPlan/' .@$text->data_values->background_image, '1920x1280') }} ');"
>
<div class="container">
