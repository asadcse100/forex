      ...
      <div class="row justify-content-center mb-none-30">
        ...
        @foreach($members as $index => $member)
            <div class="col-xl-3 col-lg-4 col-sm-6 mb-30 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.3s">
                <div class="team-card" style="background-image: url('{{ asset('ico/images/team/team-bg.jpg') }}')">
                <div class="team-card__thumb">
                    <img src="{{ getImage( 'ico/assets/images/frontend/team/' .$member->data_values->image, '275x335') }}" alt="image" class="rounded-3">
                </div>
