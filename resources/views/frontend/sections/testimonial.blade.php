...
<!-- testimonial section start -->
 <section
 class="pt-100 pb-100"
 style="background-image: url(' {{ getImage( 'ico/assets/images/frontend/testimonial/' .@$data->data_values->background_image, '1920x1280') }} ');"
>
 <div class="container">
   ...
   <div class="testimonial-slider">
    ...
    @foreach($users as $index => $user)
        ...
        <div class="testimonial-card">
            ...
            <div class="thumb"><img src="{{ getImage( 'ico/assets/images/frontend/testimonial/' .$user->data_values->image, '85x90') }}" alt="image" class="object-fit--cover"></div>
